...
<div class="row">
    ...
    <div class="col-md-6">        
      ...
      <div class="form-group row form-inline">
            ...
            <div class="col-sm-8">
                <select class="select2 form-control block" id="jenis" name="jenis" onchange="cekJenis(this.value)" required>
       ...
       <div class="form-group row form-inline">
            ...
            <div class="col-sm-8">
                <select class="select2 form-control block rst1" id="caribrg" name="caribrg" onchange="showBrg(this.value)" required>
