...
// echo "select * from (SELECT a.id_barang,
...
// 					) a
// 					LEFT JOIN ( SELECT sum( qty_mtcdtl ) AS qtyker, id_barang FROM tx_maintenancedtl WHERE status_mtcdtl = 0 AND jenis = 1 GROUP BY id_barang ) AS b ON a.id_barang = b.id_barang) as asi where id_barang = $_POST[idbarang]";
