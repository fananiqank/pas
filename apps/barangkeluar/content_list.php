...
<header class="card-header">
    ...
    <p class="card-subtitle">
        <a href="index.php?x=barangkeluar" class="btn btn-warning btn-sm" style="float: right;">Back</a>
    </p>
</header>
<div class="card-body">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel18"><i class="la la-list"></i>Detail Barang Keluar</h4>
