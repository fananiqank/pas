<?php 
$cekhead = $db->selectcount("tx_barangkeluar","no_brgkeluar as jmlkeluar","status_brgkeluar = 1");
?>
...
<div class="row">
    <div class="col-md-12">  
        <a href="index.php?x=barangkeluarlist" class="btn btn-primary"  style="font-size: 12px; float: right;">List Barang Keluar</a>
    </div>
</div>
<div class="card-body">
