...
<header class="card-header">
    ...
    <h2 class="card-title">Laporan Premi Driver</h2>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="table-responsive pre-scrollable" id="lappremix">
    ...
    <div class="modal-dialog" style="max-width: 100%" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel18"><i class="la la-list"></i>Premi Driver</h4>
