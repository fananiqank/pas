...
<header class="card-header">
    ...
    <h2 class="card-title">Laporan Invoice Periode</h2>
...
<div class="form-group row">
    <!-- <label class="col-sm-2 control-label" for="w1-username" style="text-align: center;">Gudang</label>
        ...
        <label class="col-sm-1 control-label" for="w1-username" style="text-align: center;">Periode</label> 
            ...
            <div class="col-sm-2">
                <select class="select2" id="shift_id" name="shift_id">
        ...
        <div class="col-sm-2">
            <a href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="filtermutasi(tgl1.value,tgl2.value,shift_id.value,cust_id.value)">Search</a>
        </div>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="table-responsive pre-scrollable" id="lapinvoicemutasix">
