...
<header class="card-header">
    ...
    <h2 class="card-title">Kehadiran & Kebersihan</h2>
    ...
    <div class="col-12">
        <div class="btn-group float-md-right">
            ...
            <div class="dropdown-menu arrow">
                <a class="dropdown-item" href="index.php?x=trxkehadiraninput"><i class="fa fa-calendar-check mr-1"></i>Input</a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel18"><i class="la la-list"></i>Detail Kehadiran & Kebersihan</h4>
