...
<header class="card-header">
    ...
    <h2 class="card-title">Input Kehadiran Driver</h2>
...
<div class="row">
    <div class="col-md-12">
      <div class="form-group row form-inline">
            ...
            <div class="col-sm-2">
                <input type="date" class="form-control input-sm headmas" name="tglhadir" id="tglhadir" onchange="valbul(this.value)" required>
                <input type="hidden" class="form-control input-sm headmas" name="bpbulan" id="bpbulan">
                <input type="hidden" class="form-control input-sm headmas" name="bptahun" id="bptahun">
            </div>
            <!-- <div class="col-sm-2">
            ...
            <label class="col-sm-1 control-label" for="w1-username">Shift</label>
            <div class="col-sm-2">
                <select class="select2 form-control block headmas" id="bpshift" name="bpshift" required>
