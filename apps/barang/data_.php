...
$columns = array(
	...
	array('db'      => 'nama_dep','dt'   => 3, 'field' => 'nama_dep',
		   'formatter' => function( $d, $row ) {
	...
	array('db'      => 'nama_sub','dt'   => 4, 'field' => 'nama_sub',
		   'formatter' => function( $d, $row ) {
	...
	array('db'      => 'nama_kat','dt'   => 5, 'field' => 'nama_kat',
		   'formatter' => function( $d, $row ) {
	...
	array('db'      => 'nama_satuan','dt'   => 6, 'field' => 'nama_satuan',
		   'formatter' => function( $d, $row ) {
	...
	array('db'      => 'id_barang','dt'   => 8, 'field' => 'id_barang',
		   'formatter' => function( $d, $row ) {	
...
$joinQuery = "FROM (select id_barang,kode_barang,nama_barang,nama_dep,nama_sub,nama_kat,nama_satuan,a.status
			  		from m_barang a 
