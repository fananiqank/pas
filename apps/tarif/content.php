...
<header class="card-header">
    ...
    <h2 class="card-title">Master Tarif</h2>
...
<div class="row">
    ...
    <form class="form-user" id="form" method="post" enctype="multipart/form-data" novalidate autocomplete="off">
      <div class="form-group row form-inline">
        ...
        <div class="form-group row form-inline">
            <label class="col-sm-4 control-label" for="w1-username">Tgl Mulai Tarif</label>
            <div class="col-sm-8">
                <input type="date" class="form-control input-sm" name="tarif_tglmulai" id="tarif_tglmulai" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <select class="select2 form-control block" id="type_armada" name="type_armada" required>
                    <option value="0">Pilih Type Armada</option>
         ...
         <div class="form-group row">
            <label class="col-sm-4 control-label" for="w1-username">Tarif</label>
            <div class="col-sm-8">
                
                <input type="text" class="form-control input-sm" name="tarif_harga" id="tarif_harga">
            </div>
        </div>
