        ...
        <tbody>
            <?php 
                $selbrgmas = $db->select("tx_barangkeluardtl a JOIN m_barang b ON a.id_barang=b.id_barang
                                          JOIN m_satuan c ON b.id_satuan=c.id_satuan","a.*,b.kode_barang,b.nama_barang,c.nama_satuan,CASE WHEN jenisbrg = 1 THEN 'Baru' WHEN jenisbrg = 2 THEN 'Bekas Pakai/Repair' END as jenisbarang","status_brgkeluardtl = 0","id_brgkeluardtl DESC"); 
