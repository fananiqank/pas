    ...
    <div class="col-md-12">
      <div class="form-group row form-inline">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control input-sm" id="supp_mtc" name="supp_mtc" style="width: 100%">   
            </div>
            <label class="col-sm-2 control-label" for="w1-username">Harga</label>
            <div class="col-sm-3">
    ...
    <div class="col-md-6">        
      ...
      <div class="form-group row form-inline">
       ...
       <div class="form-group row form-inline">
            ...
            <div class="col-sm-8">
                <select class="select2 form-control block rst1" id="caribrg" name="caribrg" onchange="showBrg(this.value)" >
