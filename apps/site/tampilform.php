...
<form class="form-user" id="form" method="post" enctype="multipart/form-data" novalidate autocomplete="off">
    <div class="form-group row">
        <label class="col-sm-4 control-label" for="w1-username">Lokasi Kerja</label>
        <div class="col-sm-8">
            <input type="text" class="form-control input-sm" name="nama_site" id="nama_site" required>
            <input type="hidden" class="form-control input-sm" name="id_site" id="id_site">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-4 control-label" for="w1-username">Aktif</label>
        <div class="col-sm-8">
            <select class="select2 form-control block" id="status_site" name="status_site" required>
